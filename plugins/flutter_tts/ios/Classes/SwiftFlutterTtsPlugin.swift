...
@MainActor
public class SwiftFlutterTtsPlugin: NSObject, @preconcurrency FlutterPlugin, AVSpeechSynthesizerDelegate {
  ...
  nonisolated public func speechSynthesizer(_ synthesizer: AVSpeechSynthesizer, willSpeakRangeOfSpeechString characterRange: NSRange, utterance: AVSpeechUtterance) {
    ...
    let data: [String: String] = [
      ...
      "word": (text as NSString).substring(with: characterRange)
    ]
    sendSpeechEvent("speak.onProgress", arguments: data)
  }
